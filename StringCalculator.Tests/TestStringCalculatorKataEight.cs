...
namespace StringCalculator.Tests
{
    public class TestStringCalculatorKataEight
    {
        ...
        [Fact]
        public void Add_GivenDifferentDelimiter_ShouldReturnTheSum()
        {
            // Arrange
            var numbers = "//;\n1; 2";
            var expected = "3";
        ...
        [Fact]
        public void Add_GivenLongDelimiters_ShouldReturnTheSum()
        {
            // Arrange
            var numbers = "//[|||]\n1|||2|||3";
            var expected = "6";
        ...
        [Fact]
        public void Add_GivenMultipleLongDelimiters_ShouldReturnTheSum()
        {
            // Arrange
            var numbers = "//[|||][***]\n1|||2***3";
            var expected = "6";
